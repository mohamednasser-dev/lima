    ...
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            <li class="breadcrumb-item">
                <a href="{{route('brand_products',$id)}}"
...
@section('content')
    @can('create-brands')
        <div class="card">
            <div class="card-body">
                <form method="post" id="form" action="{{route('brand_products.store')}}" enctype="multipart/form-data">
                    @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#addButton").click(function () {
                ...
                html +=   '        <input name="rows[' + i + '][title_en]" style="direction: ltr;" placeholder="ex: iron" value=""   class="form-control" type="text"  maxlength="255" />' ;
                html +=   '    </div>' ;
                ...
                html +=   '        <input name="rows[' + i + '][content_en]" style="direction: ltr;" placeholder="ex: 12g" value=""   class="form-control" type="text"  maxlength="255" />' ;
                html +=    '    </div>';
                html +=   '    <div class="form-group  col-2">' ;
                html +=   '        <label> &nbsp; </label>' ;
                html +=   '        <br>' ;
