<div class="card-body row">
    <div class="form-group  col-6">
        ...
        <input name="title_ar" placeholder="سم العلامه التجاريه بالعربيه"  value="{{ old('title_ar', $data->title_ar ?? '') }}"
    ...
    <div class="form-group  col-6">
        <label>اسم العلامه التجاريه بالانجليزيه<span
                class="text-danger">*</span></label>
        <input name="title_en" placeholder="اسم العلامه التجاريه بالعربيه"  value="{{ old('title_en', $data->title_en ?? '') }}"
    ...
    <div class="form-group col-6">
        <label>وصف الملحوظات بالانجليزيه<span
                class="text-danger">*</span></label>
        <div class="">
                <textarea class="form-control {{ $errors->has('body_en') ? 'border-danger' : '' }} "
    ...
    <div class="form-group col-6">
        <label>الرؤيه بالانجليزيه<span
                class="text-danger">*</span></label>
        <div class="">
                <textarea class="form-control {{ $errors->has('vision_en') ? 'border-danger' : '' }} "
    ...
    <div class="form-group col-6">
        <label>الرساله بالانجليزيه<span
                class="text-danger">*</span></label>
        <div class="">
                <textarea class="form-control {{ $errors->has('message_en') ? 'border-danger' : '' }} "
...
{{--            <span class="text-danger">  * يجب ان يكون ابعاد الصوره 2 : 1</span>--}}
    ...
    <div class="form-group  col-6">
        ...
        <input name="min_order" placeholder="اقل سعر للطلب"  value="{{ old('min_order', $data->min_order ?? '') }}"
               class="form-control  {{ $errors->has('min_order') ? 'border-danger' : '' }}" type="number"
               maxlength="255" />
    </div>
    <div class="form-group col-6">
        <label><span class="text-danger">*</span>المدينه</label>
        <select name="city_id"   class="form-control select2 {{ $errors->has('city_id') ? 'border-danger' : '' }}" id="kt_select2_1_modal">
