                ...
                <div class="card-body pt-4">
                    ...
                    <div class="mb-7" style="direction: rtl;">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="javascript:void(this);" class="text-muted text-hover-primary">{{$data->name}}</a>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex justify-content-between align-items-cente my-1">
                            <span class="text-dark-75 font-weight-bolder mr-2">عنوان الرسالة :</span>
                            <a href="javascript:void(this);" class="text-muted text-hover-primary">{{$data->subject}}</a>
                        </div>
                    </div>
