<div class="card-body row">
    <div class="form-group  col-4">
        ...
        <input name="name" placeholder="ادخل الاسم" value="{{ old('name', $data->name ?? '') }}"
    ...
    <div class="form-group  col-4">
        <label>البريد الالكتروني<span
                class="text-danger">*</span></label>
        <input name="email" placeholder="ادخل البريد الالكتروني" value="{{ old('email', $data->email ?? '') }}"
    ...
    <div class="form-group  col-6">
        ...
        <input name="password" placeholder="ادخل الرقم السري" value="{{ old('password') }}"
    ...
    <div class="form-group  col-6">
        ...
        <input name="password_confirmation" placeholder="ادخل تاكيد الرقم السري"
...
<div class="card-footer text-left">
    <button type="Submit" id="submit" class="btn btn-success btn-default ">تعديل</button>
