    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
        ...
        <ul class="menu-nav">
            ...
            @can('read-posts')
                ...
                <span class="svg-icon svg-icon-success svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Devices\TV1.svg--><svg
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item @if( Request::segment(1)== 'posts' && Request::segment(2)== 'video') menu-item-active @endif "
                                ...
                                <a href="{{route('posts.index',['type'=>'video'])}}" class="menu-link">
                                    ...
                                    <span class="svg-icon menu-icon">
                                    <span class="svg-icon svg-icon-success svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Devices\Video-camera.svg--><svg
