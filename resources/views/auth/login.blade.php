...
<!--end::Head-->
<!--begin::Body-->
<body id="kt_body" style="font-family: 'Tajawal', sans-serif; !important "
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
                    ...
                    <!--end::Form group-->
                        ...
                        <div class="pb-lg-0 pb-5" style="text-align: center;">
                            <button type="submit" id="kt_login_singin_form_submit_button"
                                    class="btn btn-danger font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">تسجيل
                                الدخول
                            </button>
                        </div>
                        <!--end::Action-->
        ...
        <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right"
             style="background-image: url({{asset(settings('login_pg'))}}); width: 570px ;  background-repeat: no-repeat;
